...
public class EnglishDescription implements Serializable {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id;
    private Integer isStartUsing;
    private Integer caroType;
    private Integer defaultPrint;
    private String defaultOne;
    private String defaultTwo;
    private String defaultThree;
    private String sDefaultOne;
    private String sDefaultTwo;
    private String sDefaultThree;
